...
export default function InfoContainer() {
  return (
    <>
      <div className="flex flex-col mt-[25em] bg-[#111111] xl:mt-[13.1em] xl:flex-row">
        <section className="text-white m-auto xl:mb-[32px]">
        ...
        <Image
          className="m-auto rotate-90 xl:rotate-0"
          src={arrow_right}
          alt="Right Arrow"
          height={150}
          width={100}
